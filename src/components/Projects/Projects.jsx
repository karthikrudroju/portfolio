            ...
            <Grid container spacing={4} justifyContent="center">
                <Grid item component={Card} xs={12} md={4} className={styles.project}>
                    <CardContent>
                        ...
                        <div className={styles.iconContainer}><a className={styles.icon} href="https://covid-19-api-kr.netlify.app/"><i class="fas fa-globe fa-2x"></i></a>  <a className={styles.icon} href="https://github.com/karthikrudroju/covid-19-status-2"><i class="fab fa-github fa-2x"></i></a></div>
                    </CardContent>
                </Grid>
                <Grid item component={Card} xs={12} md={4} className={styles.project}>
                    <CardContent>
                        ...
                        <div className={styles.iconContainer}><a className={styles.icon} href="https://keeper-app-kr.netlify.app/"><i class="fas fa-globe fa-2x"></i></a>  <a className={styles.icon} href="https://github.com/karthikrudroju/keeper-app"><i class="fab fa-github fa-2x"></i></a></div>
                    </CardContent>
                </Grid>
            </Grid>
        </div>
